...
return [
    'outwork' => [
        'yyj_url' => "/home/zzy/webs/mss/public/static/",
        'appid' => 'wx0bc925948532a051',
        'appSecret' => '338bb951ba84e7e1c397b6f9a60145a8',
    ...
    'exception_handle'       => function ($e) {
        ...
        if ($e instanceof think\exception\HttpException) {
            $code =  $e->getStatusCode() ?? $e->getcode() ?? 500;
        } else {
            $code =  $e->getcode() ?? 500;
        }
        dlog($e, 'error $e ');
        return  fail(['retcode' => $code, 'retmsg' => $e->getMessage()]);
    },
    // auth配置
    'auth'  => [
        'auth_on'           => 1, // 权限开关
